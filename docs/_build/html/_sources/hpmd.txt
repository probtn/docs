...
В поле "пиксели" вы можете добавить ссылку-пиксель для отслеживания количества показов баннера, но не следуеь использовать ту же ссылку, что и в admin.probtn.com - иначе пиксель будет вызываться два раза, и соответствующим образом искажаться статистика.
